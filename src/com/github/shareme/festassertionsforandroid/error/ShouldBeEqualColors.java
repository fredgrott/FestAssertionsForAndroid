...
import com.github.shareme.festassertionsforandroid.data.*;

/**
 * Creates an error message indicating that an assertion that verifies that a two colors are equal at a given
 * point fails.
 *
 * @author Yvonne Wang
 */
